...
INSERT INTO restaurant (uid, address_id) VALUES (3,3);
-- Insert sample menu for restaurant
INSERT INTO menu (menu_id, restaurant_id, title, description, price, status) VALUES (1, 3, "Soup", "best soup ever", 100, 1);
INSERT INTO menu (menu_id, restaurant_id, title, description, price, status) VALUES (2, 3, "Rice", "best rice ever", 20, 1);
INSERT INTO menu (menu_id, restaurant_id, title, description, price, status) VALUES (3, 3, "Coffee", "wakes u up", 70, 1);
INSERT INTO menu (menu_id, restaurant_id, title, description, price, status) VALUES (4, 3, "Water", "best water ever (not really)", 65, 1);
